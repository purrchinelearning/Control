...
global m1 m2 g l1 l2 Kp1 Kd1 Kp2 Kd2 E Tor
global ypos1 ypos2 yvel1 yvel2 yacc1 yacc2
...
for t=0:dt:t_fin
    ...
    yacc1= (yvel1-yvel1_before)/dt;              % theta_dot_dot_1
...
global m1 m2 g l1 l2 Kp1 Kd1 Kp2 Kd2 M C G Tor
global ypos1 ypos2 yvel1 yvel2 yacc1 yacc2
xd(1)=x(3);
xd(2)=x(4);
...
xd(3) = yacc1+Kd1*(yvel1-x(3))+Kp1*(ypos1-x(1));
xd(4) = yacc2+Kd2*(yvel2-x(4))+Kp2*(ypos2-x(2));
xdot=xd';
